...
export default function LandingPage() {
  ...
  // Strumenti per tutti (privati e pro)
  const tools = [
  ...
  // Community cards (focus su aiuto e condivisione, non rete/punti)
  const communityCards = [
    { icon: Users, title: t('communityCard1Title'), desc: t('communityCard1Description'), color: 'from-indigo-500 to-purple-600' },
    { icon: HeartHandshake, title: t('communityCard2Title'), desc: t('communityCard2Description'), color: 'from-purple-500 to-pink-500' },
    { icon: Share2, title: t('communityCard3Title'), desc: t('communityCard3Description'), color: 'from-yellow-500 to-orange-500' }
  ]

  // Come ottenere i vantaggi (Uso + Condivisione)
  const steps = [
    { step: '1', icon: Zap, title: t('step1Title'), desc: t('step1Description') },
    { step: '2', icon: Share2, title: t('step2Title'), desc: t('step2Description') },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-900 to-purple-900 overflow-x-hidden">
      ...
      {/* Hero Section - SENZA CAROSELLO, più pulita e bilanciata */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-4 sm:mb-6 leading-tight break-words">
                {t('heroTitle')}
              ...
              {/* Stats aggiornate per privati e pro */}
              <div className="grid grid-cols-3 gap-4 sm:gap-6 border-t border-white/10 pt-8">
                <div>
                  <div className="text-2xl sm:text-3xl font-bold text-white">10K+</div>
                  <div className="text-xs sm:text-sm text-gray-400 mt-1">{t('statActiveUsers')}</div>
                </div>
                <div>
                  <div className="text-2xl sm:text-3xl font-bold text-yellow-400">12+</div>
                  <div className="text-xs sm:text-sm text-gray-400 mt-1">{t('statToolsLabel')}</div>
                </div>
                <div>
                  <div className="text-2xl sm:text-3xl font-bold text-white">50+</div>
                  <div className="text-xs sm:text-sm text-gray-400 mt-1">{t('statCountriesLabel')}</div>
                </div>
              </div>
            </div>

            {/* Grafica Hero Alternativa (Abstract / Illustrativa) al posto del carosello */}
            <div className="relative hidden lg:block">
              <div className="absolute inset-0 bg-gradient-to-tr from-indigo-500/30 to-purple-500/30 rounded-full blur-3xl animate-pulse"></div>
              <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
                <div className="space-y-6">
                  <div className="flex items-center gap-4 p-4 bg-white/5 rounded-2xl border border-white/5">
                    ...
                    <div>
                      <div className="text-white font-bold">{t('heroCard1Title')}</div>
                      <div className="text-gray-400 text-sm">{t('heroCard1Desc')}</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-4 bg-white/5 rounded-2xl border border-white/5">
                    ...
                    <div>
                      <div className="text-white font-bold">{t('heroCard2Title')}</div>
                      <div className="text-gray-400 text-sm">{t('heroCard2Desc')}</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-4 bg-white/5 rounded-2xl border border-white/5">
                    ...
                    <div>
                      <div className="text-white font-bold">{t('heroCard3Title')}</div>
                      <div className="text-gray-400 text-sm">{t('heroCard3Desc')}</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {/* 🌐 SEZIONE: LA TUA COMMUNITY (Rivisitata: niente rete/punti, solo persone) */}
      <section className="py-12 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Box trasparenza: focus su community reale */}
      ...
      {/* 🛠️ SEZIONE: GLI STRUMENTI PER TUTTI (Privati e Pro) */}
      ...
      {/* 🎟️ SEZIONE: VANTAGGI E COUPON (Uso e Condivisione) */}
      <section className="py-12 sm:py-20 bg-gradient-to-b from-black/40 to-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Come funziona: Usa, Condividi, Ottieni */}
