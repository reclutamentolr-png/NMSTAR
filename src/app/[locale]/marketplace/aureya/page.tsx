    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_10%_0%,#e7eaff,transparent_32%),linear-gradient(135deg,#f7f8ff,#eef5f3)]">
      <header className="sticky top-0 z-10 border-b border-indigo-900/10 bg-[#161936]/95 text-white shadow-lg backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          <ToolBackLink
            className="flex items-center gap-2 text-sm font-medium text-indigo-100 transition-colors hover:text-white"
            dashboardLabel={<><ArrowLeft className="h-5 w-5" /> {commonT('backToDashboard')}</>}
          >
            <ArrowLeft className="h-5 w-5" /> {t('backToMarketplace')}
          </ToolBackLink>
      ...
      <main className="mx-auto max-w-5xl px-4 py-10 sm:px-6 sm:py-16 lg:px-8">
        <div className="mx-auto mb-8 max-w-3xl text-center">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-white/70 px-4 py-1.5 text-sm font-semibold text-indigo-800 shadow-sm">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Link
            ...
            className="group rounded-2xl border border-indigo-100 bg-white/80 p-6 shadow-sm transition-all hover:border-indigo-300 hover:shadow-md"
          >
            <div className="mb-4 inline-flex rounded-2xl bg-indigo-600 p-3 text-white"><Ear className="h-7 w-7" /></div>
            ...
            <span className="mt-4 inline-block text-sm font-semibold text-indigo-700 group-hover:underline">{t('acousticCardCta')} &rarr;</span>
          </Link>

          <Link
            href="/marketplace/aureya/visivo"
            className="group rounded-2xl border border-teal-100 bg-white/80 p-6 shadow-sm transition-all hover:border-teal-300 hover:shadow-md"
          >
            <div className="mb-4 inline-flex rounded-2xl bg-teal-600 p-3 text-white"><Eye className="h-7 w-7" /></div>
            ...
            <span className="mt-4 inline-block text-sm font-semibold text-teal-700 group-hover:underline">{t('visualCardCta')} &rarr;</span>
          </Link>
        </div>
                ...
                return (
                  <li key={row.id} className="flex items-center justify-between gap-4 px-5 py-3">
                    <div className="flex items-center gap-3">
                      {isAcoustic ? <Ear className="h-4 w-4 text-indigo-600" /> : <Eye className="h-4 w-4 text-teal-600" />}
                      <div>
